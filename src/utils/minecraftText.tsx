...
/**
 * Parses Minecraft-style lore strings into React elements.
 * Supports splitting into multiple <span> blocks per line to match .mctooltip > span CSS rules.
 */
export function parseMinecraftLore(text: string): React.ReactNode[] {
  if (!text) return [];
  ...
  let currentCode = '7';
  let currentFormatting: React.CSSProperties = {};
